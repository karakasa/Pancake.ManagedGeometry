...
namespace CrossLibBenchmark.BasicGeometry
{
    ...
    public class ClosestPtOnLine
    {
        ...
        private Line3d sampleLine1;
        private GShark.Geometry.Line sampleLine2;
        private Elements.Geometry.Line sampleLine3;
        ...
        public void Setup()
        {
            ...
            sampleLine1 = new Line3d((0, 0, 0), (1, 1, 1));
            sampleLine2 = new GShark.Geometry.Line(new GShark.Geometry.Point3(0, 0, 0), new GShark.Geometry.Point3(1, 1, 1));
            sampleLine3 = new Elements.Geometry.Line(new Elements.Geometry.Vector3(0, 0, 0), new Elements.Geometry.Vector3(1, 1, 1));
        }
        ...
        public double Pancake()
        {
            ...
            foreach(var it in samplePt1)
                unchecked
                {
                    sum += (it - sampleLine1.PointAt(sampleLine1.NearestPoint(it))).Length;
                }
        ...
        public double GShark()
        {
            ...
            foreach (var it in samplePt2)
                unchecked
                {
                    sum += (sampleLine2.ClosestPoint(it) - it).Length;
                }
